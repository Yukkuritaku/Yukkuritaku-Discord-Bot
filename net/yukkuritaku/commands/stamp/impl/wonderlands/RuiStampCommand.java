...
public class RuiStampCommand extends Command {
    ...
    protected void execute(CommandEvent event) {
        try{
            ...
            embedBuilder.setImage("https://sekai-res.dnaroma.eu/file/sekai-assets/stamp/" + ruiStamp + "_rip/" + ruiStamp + "/" + ruiStamp + ".webp");
            embedBuilder.setColor(0xBB88EE);
