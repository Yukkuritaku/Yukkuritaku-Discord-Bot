...
//ちなみに主はえむちゃんも推してる
public class EmuStampCommand extends Command {

    public EmuStampCommand(){
        this.name = "stampemu";
        this.help = "えむちゃんのスタンプからどれかが選ばれるよ";
        this.aliases = new String[] {"emu", "えむ", "えむちゃん", "鳳えむ", "鳳えむちゃん", "わんだほーい！", "魔王様のお世話係えむむ", "ぷぎゅ"};
    }
    ...
    protected void execute(CommandEvent event) {
        try {
            ...
            embedBuilder.setImage("https://sekai-res.dnaroma.eu/file/sekai-assets/stamp/" + emuStamps + "_rip/" + emuStamps + "/" + emuStamps + ".webp");
            embedBuilder.setColor(0xFF66BB);
