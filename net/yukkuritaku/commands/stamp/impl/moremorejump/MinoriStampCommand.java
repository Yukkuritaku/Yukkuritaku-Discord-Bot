...
public class MinoriStampCommand extends Command {
    ...
    protected void execute(CommandEvent event) {
        try{
            ...
            embedBuilder.setImage("https://sekai-res.dnaroma.eu/file/sekai-assets/stamp/" + minoriStamp + "_rip/" + minoriStamp + "/" + minoriStamp + ".webp");
            embedBuilder.setColor(0xFFCCAA);
            ...
            ReplyUtils.logException(event, e);
            e.printStackTrace();
        }
    }
