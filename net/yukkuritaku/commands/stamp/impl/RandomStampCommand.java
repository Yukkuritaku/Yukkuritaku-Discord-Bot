...
public final class RandomStampCommand extends Command {
    ...
    protected final void execute(final CommandEvent event) {
        try {
            ...
            embedBuilder.setImage("https://sekai-res.dnaroma.eu/file/sekai-assets/stamp/" + randomStamps + "_rip/" + randomStamps + "/" + randomStamps + ".webp");
            embedBuilder.setColor(ColorUtils.astolfo(1, 1, 0.4f, 1.0f, 1));
            ReplyUtils.logInfo(event, "表示されなかったら教えてください");
            System.out.println("https://sekai-res.dnaroma.eu/file/sekai-assets/stamp/" + randomStamps + "_rip/" + randomStamps + "/" + randomStamps + ".webp");
            event.reply(embedBuilder.build());

            final long end = System.nanoTime();
            ReplyUtils.logInfo(event, "Done in " + (end - start) / 1000000f + "ms");
        }
