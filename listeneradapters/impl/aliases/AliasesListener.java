...
public class AliasesListener extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(@NotNull GuildMessageReceivedEvent event) {
        ...
        if (args[0].equalsIgnoreCase(Main.PREFIX + "testaliases")){
            if (args.length < 2){
                String escape = "\n";
                ...
                builderUsage.setDescription(Main.PREFIX + "testaliases <数字>"
                ...
                if (args[1].equalsIgnoreCase("1")){
                    ...
                    virtualsinger.setColor(ColorUtils.VIRTUAL_SINGER.color);
                    ...
                    moremorejump.setColor(ColorUtils.MORE_MORE_JUMP.color);
                    ...
                    vividbadsquad.setColor(ColorUtils.VIVID_BAD_SQUAD.color);
                    ...
                    wonderlands.setColor(ColorUtils.WONDER_LANDS_SHOWTIME.color);
